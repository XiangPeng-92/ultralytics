...
class Annotator:
    ...
    def count_labels(
        ...
        t_size_out = cv2.getTextSize(str(out_count), 0, fontScale=tl / 2, thickness=tf)[
            0
        ]
        ...
        cv2.rectangle(
            self.im,
            (text_x1 - 5, text_y - 5),
            (text_x1 + text_width + 7, text_y + t_size_in[1] + 7),
            color,
            -1,
        )
        cv2.putText(
        ...
        cv2.rectangle(
            self.im,
            (text_x2 - 5, text_y - 5),
            (text_x2 + text_width + 7, text_y + t_size_out[1] + 7),
            color,
            -1,
        )
        cv2.putText(
